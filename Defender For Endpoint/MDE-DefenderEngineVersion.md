...
```kql
DeviceInfo
| where DeviceName contains "bvassessment01"
| extend MDEEngine = split(ClientVersion,".")[1]
| project Timestamp, ClientVersion,MDEEngine, OSPlatform, OSBuild, OsBuildRevision, OSVersion, OSVersionInfo
```
